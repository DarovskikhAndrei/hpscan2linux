...
public class WalkupScanToCompDestinationResponse extends ResponseExecutor {
	...
	public void init(HttpResponse response) {
		...
		try {
			...
			if (m_hostname == null)
				m_hostname = getXMLParam(doc, "Hostname", "http://www.hp.com/schemas/imaging/con/dictionaries/2009/04/06");
			
			m_scanProfile = getXMLParam(doc, "Shortcut", "http://www.hp.com/schemas/imaging/con/ledm/walkupscan/2010/09/28");
