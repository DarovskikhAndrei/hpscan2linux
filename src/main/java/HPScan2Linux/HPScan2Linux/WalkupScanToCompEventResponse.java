...
public class WalkupScanToCompEventResponse extends ResponseExecutor {
	@Override
	public void execute() {
	...
	public void init(HttpResponse response) {
		...
		try {
			...
			m_eventType = getXMLParam(doc, "WalkupScanToCompEventType", "http://www.hp.com/schemas/imaging/con/ledm/walkupscan/2010/09/28");
